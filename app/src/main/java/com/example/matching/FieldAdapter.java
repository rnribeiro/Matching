...
public class FieldAdapter extends ArrayAdapter<Field> {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.activity_field_adapter, parent, false);
        }
        TextView tv = (TextView) convertView.findViewById(R.id.adp_field_name);
        ImageView iv = (ImageView) convertView.findViewById(R.id.adp_field_image);
